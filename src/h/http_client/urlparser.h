...
struct parsed_url *parse_url(const char *url)
{
	...
	memset(purl->scheme, 0, sizeof(char) * (len + 1));
	...
	memset(purl->username, 0, sizeof(char) * (len + 1));
	...
	memset(purl->password, 0, sizeof(char) * (len + 1));
	...
	memset(purl->host, 0, sizeof(char) * (len + 1));
	...
	memset(purl->port, 0, sizeof(char) * (len + 1));
	...
	memset(purl->path,  0, sizeof(char) * (len + 1));
	...
	memset(purl->query,  0, sizeof(char) * (len + 1));
	...
	memset(purl->fragment,  0, sizeof(char) * (len + 1));
